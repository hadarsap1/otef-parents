  ...
  return (
    <div className="space-y-4 pb-4">
      ...
      {session.user.role === "ADMIN" && (
        <Section icon={Shield} title='ניהול מערכת (אדמין)'>
          <p>כאדמין, יש לכם גישה ללשונית <strong>ניהול</strong> עם:</p>
          <Step num={1} text="צפייה בכל הקבוצות ורשימות הילדים." />
          <Step num={2} text="עריכת שמות קבוצות והסרת ילדים." />
          <Step num={3} text="ניהול משתמשים: שינוי תפקיד (הורה/מורה/אדמין), איפוס נתונים ומחיקת משתמשים." />
        </Section>
      )}
