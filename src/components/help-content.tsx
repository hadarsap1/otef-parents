  ...
  return (
    <div className="space-y-4">
      ...
      <Section icon={Clock} title='שיעורים'>
        <p>
          בעמוד <strong>שיעורים</strong> מוצג לוח השיעורים השבועי של הכיתות.
        </p>
      ...
      {showTeacher && (
        <Section icon={UsersRound} title='ניהול מורה'>
          ...
          <Step num={10} text="אפשר ליצור שיעור למספר כיתות בבת אחת, עם שעות שונות לכל כיתה." />
          <Step num={11} text="עריכת שיעור קיים - שינוי כותרת, שעות או קישור זום." />
          <Step num={12} text="מחיקת שיעור." />
          <Step num={13} text="צפייה בשיעורים מקובצים לפי כיתה, עם מספר חברי הכיתה." />
      ...
      {showAdmin && (
        <Section icon={Shield} title='ניהול מערכת (מנהל-על)'>
          ...
          <Step num={1} text="צפייה בכל בתי הספר, הכיתות ורשימות הילדים." />
          <Step num={2} text="עריכת שמות כיתות והסרת ילדים." />
