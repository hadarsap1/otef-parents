  ...
  return (
    <div className="space-y-4">
      ...
      <Section icon={Clock} title='שיעורים'>
        ...
        <Step num={5} text='שיעורי העשרה מסומנים בתגית ✨ "העשרה" — אלו שיעורים לא חובה.' />
        <div className="space-y-1">
      ...
      {showTeacher && (
        <Section icon={UsersRound} title='ניהול מורה'>
          ...
          <Step num={9} text="בחרו בית ספר, ואז כיתות — אפשר לבחור מספר כיתות בו-זמנית (או את כולן)." />
          <Step num={10} text="יצירת שיעור עם כותרת, תאריך, שעה וקישור זום." />
          <Step num={11} text="בחרו תדירות: חד פעמי, שבועי או יומי." />
          <Step num={12} text='סמנו "העשרה (לא חובה)" אם השיעור לא חובה — ההורים יראו תגית העשרה ליד השיעור.' />
          <Step num={13} text="חלוקה לקבוצות (אופציונלי): משבצות זמן (ההורים בוחרים) או שיבוץ ידני." />
          <Step num={14} text="עריכת שיעור קיים - שינוי כותרת, תאריך, שעות או קישור זום." />
          <Step num={15} text="מחיקת שיעור (עם אישור)." />
