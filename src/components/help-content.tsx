  ...
  return (
    <div className="space-y-4">
      ...
      <Section icon={LogIn} title="התחלה מהירה">
        ...
        <Step num={2} text='הזינו קוד הזמנה שקיבלתם מהמורה כדי להצטרף לקבוצה בבית הספר.' />
        <Step num={3} text='עברו ללשונית "ילדים" ובחרו את הילד/ה שלכם מהרשימה.' />
        <Step num={4} text="זהו! אתם מחוברים לקבוצה ויכולים לראות מפגשים ושיעורים." />
      </Section>
      ...
      {showTeacher && (
        <Section icon={UsersRound} title='ניהול מורה'>
          ...
          <h3 className="font-semibold text-sm mt-3 mb-1">ניהול קבוצות</h3>
          <Step num={1} text="יצירת קבוצה חדשה עם שם ותיאור." />
          <Step num={2} text="עריכת שם ותיאור של קבוצה קיימת." />
          <Step num={3} text="מחיקת קבוצה (עם אישור לפני המחיקה)." />

          <h3 className="font-semibold text-sm mt-3 mb-1">הוספת תלמידים</h3>
          <p>
            אפשר להוסיף תלמידים לקבוצה בשתי דרכים:
          </p>
          <Step num={4} text="הוספה ידנית - בכרטיס הקבוצה, לחצו על ״הוספת ילד״ והזינו שם." />
          ...
          <Step num={7} text='לחצו על "יצירת קוד הזמנה" בכרטיס הקבוצה - הקוד תקף ל-7 ימים.' />
          <Step num={8} text="העתיקו את הקוד בלחיצה ושלחו להורים כדי שיצטרפו לקבוצה." />

          <h3 className="font-semibold text-sm mt-3 mb-1">ניהול שיעורים</h3>
          <Step num={9} text="יצירת שיעור חדש עם כותרת, יום, שעת התחלה וסיום, וקישור זום." />
          <Step num={10} text="אפשר ליצור שיעור למספר קבוצות בבת אחת, עם שעות שונות לכל קבוצה." />
          <Step num={11} text="עריכת שיעור קיים - שינוי כותרת, שעות או קישור זום." />
          <Step num={12} text="מחיקת שיעור." />
          <Step num={13} text="צפייה בשיעורים מקובצים לפי קבוצה, עם מספר חברי הקבוצה." />
