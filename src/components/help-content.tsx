    ...
    <div className="space-y-4">
      ...
      {showTeacher && (
        <Section icon={UsersRound} title='ניהול מורה'>
          ...
          <Step num={4} text='לחצו על "יצירת קוד הזמנה" בכרטיס הקבוצה — הקוד תקף ל-7 ימים.' />
          <Step num={5} text="העתיקו את הקוד בלחיצה ושלחו להורים כדי שיצטרפו לקבוצה." />

          <h3 className="font-semibold text-sm mt-3 mb-1">ניהול שיעורים</h3>
          <Step num={6} text="יצירת שיעור חדש עם כותרת, יום, שעת התחלה וסיום, וקישור זום." />
          <Step num={7} text="אפשר ליצור שיעור למספר קבוצות בבת אחת, עם שעות שונות לכל קבוצה." />
          <Step num={8} text="עריכת שיעור קיים — שינוי כותרת, שעות או קישור זום." />
          <Step num={9} text="מחיקת שיעור." />
          <Step num={10} text="צפייה בשיעורים מקובצים לפי קבוצה, עם מספר חברי הקבוצה." />
